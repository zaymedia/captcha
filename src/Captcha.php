...
class Captcha
{
    ...
    {
        $this->identifierHash = md5('captcha.' . $this->identifier);
    }

    /**
     * Make new Captcha instance.
     */
     ...
     */
    public function generateLinks(int $amount = 4, bool $withRandomFlip = true): array
    {
        return $this->cacheAdapter->remember($this->identifierHash, $this->expiresIn, function () use ($amount, $withRandomFlip) {
            ...
            if ($withRandomFlip && random_int(0, 1)) {
